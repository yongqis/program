...
class Match(object):
    ...
    def matched_column_indices(self):
        ...
        """
        # tf.greater返回一个bool类型的tensor，保持x位置的shape，即正类anchor为true,其他为false
        # tf.where 当只有条件时，返回一个tensor二维矩阵是shape[true_num, 维度数量],value是 为true的值 坐标
        # 由于match_results本身的一维，即维度数ndims为1,故展开成一维，
