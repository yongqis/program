...
from object_detection_updata.models import ssd_mobilenet_v1_feature_extractor
from object_detection_updata.models import ssd_mobilenet_v1_keras_feature_extractor
