...
from object_detection_updata.builders import dataset_builder
...
from object_detection_updata.builders import preprocessor_builder
from object_detection_updata.core import preprocessor
from object_detection_updata.core import standard_fields as fields
from object_detection_updata.data_decoders import tf_example_decoder
from object_detection_updata.protos import eval_pb2
from object_detection_updata.protos import input_reader_pb2
from object_detection_updata.protos import model_pb2
from object_detection_updata.protos import train_pb2
...
def create_train_input_fn(train_config, train_input_config, model_config):
    ...
    def _train_input_fn(params=None):
        ...
        def transform_and_pad_input_data_fn(tensor_dict):
            ...
            model_preprocess_fn = INPUT_BUILDER_UTIL_MAP['model_build'](model_config, is_training=True).preprocess
