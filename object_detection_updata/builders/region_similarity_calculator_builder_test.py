...
from object_detection_updata.builders import region_similarity_calculator_builder
from object_detection_updata.core import region_similarity_calculator
from object_detection_updata.protos import region_similarity_calculator_pb2 as sim_calc_pb2
