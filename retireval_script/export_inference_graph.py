...
flags.DEFINE_string('pipeline_config_path',
                    r'/home/hnu/workspace/syq/retrieval/data/all_class/saved_model/5-7/pipeline.config',
                    'Path to a pipeline_pb2.TrainEvalPipelineConfig config file.')
flags.DEFINE_string('trained_checkpoint_prefix',
                    '/home/hnu/workspace/syq/retrieval/data/all_class/saved_model/5-7/model.ckpt-58112',
                    'Path to trained checkpoint, typically of the form path/to/model.ckpt')
flags.DEFINE_string('output_directory',
                    '/home/hnu/workspace/syq/retrieval/data/all_class/saved_model',
